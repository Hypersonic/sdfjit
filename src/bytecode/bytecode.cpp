  ...
  for (size_t i = 0; i < ast.nodes.size(); i++) {
    ...
    case sdfjit::ast::Op::Box: {
      ...
      */
      ...
      auto box_wx = ast_results.at(node.children.at(1))[0];
    ...
    case sdfjit::ast::Op::Pos3: {
      ...
      // appropriately.
      auto x = ast_results.at(node.children.at(0))[0];
      auto y = ast_results.at(node.children.at(1))[0];
      auto z = ast_results.at(node.children.at(2))[0];
      ast_results[i] = {x, y, z};
      break;
    }
